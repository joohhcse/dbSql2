...
BEGIN
    UPDATE dept_test 
    SET dept_test.dname = p_dname, dept_test.loc = p_loc 
    WHERE dept_test.deptno = p_deptno;
    COMMIT;
...
-- java와 다르게 plsql에서는 ARRAY 역할을 하는 table type의 인덱스를 숫자 뿐만 아니라 문자열 형태도 가능하다
